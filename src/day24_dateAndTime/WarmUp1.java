...
//2
        ...
        System.out.println("---------------------------------------------------------------------------");
//3
        double max = employees.get(0).salary; //assumption
        double min = employees.get(0).salary; //assumption
        for (Employee each : employees) {
            if(each.salary > max){
                max = each.salary;
...
ArrayList < Employee > maleEmployees = new ArrayList<>();
        ...
        System.out.println("female employee number: "+ femaleEmployees.size());
        System.out.println("male employee number: " + maleEmployees.size());
