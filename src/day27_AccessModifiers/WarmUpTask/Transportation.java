...
public abstract class Transportation {
    ...
    public abstract void transportPeople();   //MUST BE OVERRIDDEN



    public abstract void start();    //abstract method MUST BE OVERRIDDEN



    public void stop(){  //non-abstract method CAN BE OVERRIDDEN
