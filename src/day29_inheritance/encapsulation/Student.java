...
public class Student {
    ...
    public void setAge(int age) {
        if (age < 0) {   // we added this condition extra
...
//even though we do not have any conditions for some instance variable(name, schoolName) , do not change them to public because
    //in future you may change something for requirements
...
1. Create a class named Student:
            ...
            Methods:
                study(), toString() ==> even this is not in requirements, you must create it
